        ...
        const midTab = (data) => {
            return (
                <div style={{ marginLeft: isMobile ? 0 : "138px", display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    ...
                    <img style={{ marginTop: isMobile ? 24 : 25, width: isMobile ? "100%" : "100%", maxWidth: 681, padding: data.heading=='Commodities'? 25:0,boxShadow: data.heading=='Commodities'?"0px 0px 2px rgba(0, 0, 0, 0.2), 0px 2px 10px rgba(0, 0, 0, 0.1)":""  }} src={data.img} />
                </div>
            )
        }
