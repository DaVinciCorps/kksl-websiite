...
export default function Tools() {
    ...
    const section1 = () => {
                ...
                <div style={{ marginTop: 42, }}>
                    <div style={{ display: 'flex', }}>
                        <div style={{ marginRight: 32, display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                            <input style={{ width: isMobile ? 16 : 24, height: isMobile ? 16 : 24, margin: 0, cursor: 'pointer' }} type="radio" id="Buy" value={"Buy"} name={"radio"} onClick={handleRadio} checked={radioValue == "Buy"} />
                        ...
                        <div style={{ marginRight: 32, display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                            <input style={{ width: isMobile ? 16 : 24, height: isMobile ? 16 : 24, margin: 0, cursor: 'pointer' }} type="radio" id="Sell" value={"Sell"} name={"radio"} onClick={handleRadio} />
                        ...
                        <div style={{ marginRight: 32, display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                            <input style={{ width: isMobile ? 16 : 24, height: isMobile ? 16 : 24, margin: 0, cursor: 'pointer' }} type="radio" id="Intraday" value={"Intraday"} name={"radio"} onClick={handleRadio} />
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: isMobile ? "column" : 'row' }}>
                        <div style={{ marginTop: 80, flex: 1, marginRight: isMobile ? 0 : 30, }}>
                            <p style={{ fontSize: isMobile ? 14 : 16, lineHeight: isMobile ? "17.57px" : "20.08px", fontFamily: 'Mulish', color: '#161A1B', fontWeight: 600 }}>
                                Shares to Buy NSE
                            </p>
                            <div style={{ flex: 1, display: 'flex', border: "1px solid #161A1B", borderRadius: 8, width: isMobile ? "" : "100%", marginTop: 6, padding: "14px 20px", minWidth: isSmall ? "240px" : isMobile ? "" : "", maxWidth: isMobile ? "" : 319, minWidth: isMobile ? "" : 319 }} >
                            ...
                            <div style={{ flex: 1, display: 'flex', border: "1px solid #161A1B", borderRadius: 8, width: isMobile ? "" : "100%", marginTop: 6, padding: "14px 20px", minWidth: isSmall ? "240px" : isMobile ? 300 : "", maxWidth: isMobile ? "" : 319, minWidth: isMobile ? "" : 319 }} >
                        ...
                        <div className={classes.brokerageDetail} style={{ flex: 1, marginTop: 30, backgroundColor: "#E5E5E5", padding: isMobile ? "32px 30px 75px 30px" : "32px 58px 75px 58px", minWidth: isMobile ? "" : 442, }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: isMobile ? "wrap" : "" }}>
                                <div style={{ display: 'flex', flexDirection: 'column', marginTop: 10 }}>
                                    <p style={{ fontSize: isMobile ? 14 : 18, lineHeight: isMobile ? "17px" : "22.59px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 600 }}>Total Order Value</p>
                                    <p style={{ fontSize: isMobile ? 16 : 24, lineHeight: isMobile ? "22px" : "30px", fontFamily: 'Mulish', color: '#161A1B', fontWeight: 700, marginTop: 15 }}> ₹{numberWithCommas(parseInt(total.totalOrder))}</p>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', marginTop: 10 }}>
                                    <p style={{ fontSize: isMobile ? 14 : 18, lineHeight: isMobile ? "17px" : "22.59px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 600 }}>Total Charges</p>
                                    <p style={{ fontSize: isMobile ? 16 : 24, lineHeight: isMobile ? "22px" : "30px", fontFamily: 'Mulish', color: '#161A1B', fontWeight: 700, marginTop: 15 }}> ₹{numberWithCommas(parseInt(total.totalCharge))}</p>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', marginTop: 10 }}>
                                    <p style={{ fontSize: isMobile ? 14 : 18, lineHeight: isMobile ? "17px" : "22.59px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 600 }}>Net Value</p>
                                    <p style={{ fontSize: isMobile ? 16 : 24, lineHeight: isMobile ? "22px" : "30px", fontFamily: 'Mulish', color: '#161A1B', fontWeight: 700, marginTop: 15 }}> ₹{numberWithCommas(parseInt(total.netVal))}</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid rgba(0, 0, 0, 0.3)", margin: "32px 0px 0px 0px" }} />
                            <div style={{ marginTop: 32, }}>
                                <div style={{ display: 'flex', alignItems: 'center', }}>
                                    <p style={{ fontSize: isMobile ? 16 : 24, lineHeight: isMobile ? "22px" : "30px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 700 }}>
                                        Charges Breakup
                                    </p>
                                    {!show &&
                                ...
                                <Expand open={show}>
                                    <div style={{ marginTop: 8 }}>
                                        <div style={{ display: 'flex', justifyContent: "space-between", marginTop: 16, }}>
                                            <p style={{ fontSize: isMobile ? 14 : 16, lineHeight: "20.08px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 500 }}>
                                                Charges
                                            </p>
                                            <p style={{ fontSize: isMobile ? 14 : 16, lineHeight: "20.08px", fontFamily: 'Mulish', color: 'rgba(22, 26, 27, 0.6)', fontWeight: 500 }}>
        ...
        return (
            <div style={{ margin: isMobile ? "24px 6.4% 0px" : isTab ? "88px 7.2% 0px" : "133px 7.2% 0px", boxShadow: '0px 0px 4px rgba(0, 0, 0, 0.1), 0px 8px 40px rgba(0, 0, 0, 0.2)', padding: isSelected == 0 || isSelected == 2 ? isMobile ? "24px 16px" : "40px 4.3% 82px 9.2%" : isSelected == 2 ? "40px 0px 0px 60px" : isMobile ? "24px 16px" : "40px 4.3% 82px 9.2%", borderRadius: isMobile ? 15 : 0 }}>
                {tabs()}
