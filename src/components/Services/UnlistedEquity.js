        ...
        return (
            <div style={{display: 'flex', justifyContent: 'space-between', margin: "80px 14.4% 0px 14.4%" }}>
                ...
                <div style={{marginLeft: 20}}>
                    <p style={{fontWeight: 'bold',marginTop: 0,  fontSize: 36, color: '#161A1B', lineHeight: "43.2px",fontFamily: 'Mulish'}}>Unlisted Equity</p>
            ...
            <div style={{marginTop: 160,margin: "160px 7.2% 0px 7.2%"}}>
                ...
                <div style={{marginTop: 56,display: 'flex', justifyContent: 'space-between'}}>
                    <div style={{}}>
                        ...
                        <div style={{maxWidth: 284,marginTop: 32,border: "1px solid rgba(0, 0, 0, 0.15)",boxShadow: "0px 0px 3px rgba(0, 0, 0, 0.1), 0px 4px 20px rgba(0, 0, 0, 0.15)", borderRadius: 15, padding: '24px 24px 52px 24px'}}>
                        <p style={{fontWeight: 400, textAlign: "center" ,fontSize: 16, color: '#161A1B', lineHeight: "26px",fontFamily: 'Mulish'}}>
