...
export default function UnlistedModal(props) {
    ...
    const handleSubmit = () => {
        ...
        if (name && phone && email && checkEmail(email) && checkPhone(phone)) {
            ...
            axios({
                method: "post",
                url: url + "data/internation_investment",
                data: formData,
            ...
            >
                <div style={{ width: 450, background: 'white', display: 'flex', flexDirection: "column", alignItems: 'center', justifyContent: 'center', padding: 40 }}>
                    ...
                    {/* <TextField
                        ...
                        style={{ marginTop: 50 }}
                    /> */}
                    <button onClick={handleSubmit} className={classes.signInButton} style={{ backgroundColor: (name && phone && email) ? "#2584F4" : "", margin: "auto", marginTop: 50 }}>
                        Submit
                    </button>
                </div>
